...
namespace Assets.draco18s.ui {
	...
	public static class ButtonExtensions {
		...
		public static void AddHover(this Slider slider, OnHoverDelegate callback)
		{
			AddHover(slider, callback, true);
		}
		public static void AddHover(this Slider slider, OnHoverDelegate callback, bool redrawOnUpdate)
		{
			TooltipTrigger trig = slider.handleRect.gameObject.GetComponent<TooltipTrigger>();
			if (trig == null)
				trig = slider.handleRect.gameObject.AddComponent<TooltipTrigger>();
			trig.AddHover(callback, redrawOnUpdate);
		}
